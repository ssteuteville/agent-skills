...
Aggregates yesterday's work + today's plan into a paste-ready Yesterday / Today / Blockers summary. Pulls Jira ticket movement on the SK project, cross-repo GitHub commits and PRs across the SkySlope org, Slack mentions and unread threads in Skunks team channels, and today's Calendar. Renders in chat for review and (after confirmation) DMs the result to the user's self-DM.
